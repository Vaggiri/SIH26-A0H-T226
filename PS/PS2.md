...
As voice-controlled IoT proliferates, processing everything in the cloud is too costly, privacy-invasive, and slow. The future belongs to hybrid architectures where the edge handles the initial 'wake-up' and the cloud handles the heavy lifting.
...
* **No Pre-Trained Global Keywords:** Teams cannot use models pre-trained on generic smart-assistant keywords like 'Hey Google' or 'Alexa'. They need to train on a custom keyword.

---

### Expected Solution & Technical Boundaries
...
* **Custom Keyword Support:** The model must work accurately for the specified custom keyword.
